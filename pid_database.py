...
_SPX_RAW = [
    ...
    (r'\bGV.?A\b|GLOBE.*ACTUATOR',
     _eq("Actuator Globe Valve",       "GV-A",   "Cast Iron", "Industry", "EA", "utility", "chiller")),
    (r'\bGV.?M\b|GLOBE.*MANUAL',
     _eq("Manual Globe Valve",         "GV-M",   "Cast Iron", "Industry", "EA", "utility", "chiller")),
    (r'\bGV.?S\b|GLOBE.*SOLENOID',
     _eq("Solenoid Globe Valve",       "GV-S",   "Cast Iron", "Industry", "EA", "utility", "chiller")),
    (r'\bGV.?LC\b|GLOBE.*MODULATING|GLOBE.*LINEAR',
     _eq("Modulating Globe Valve",     "GV-LC",  "Cast Iron", "Industry", "EA", "utility", "chiller")),
    (r'\bBV.?A\b|BALL.*ACTUATOR',
     _eq("Actuator Ball Valve",        "BV-A",   "Brass",     "Industry", "EA", "utility", "chiller")),
    (r'\bBV.?M\b|BALL.*MANUAL|MANUAL.*BALL',
     _eq("Manual Ball Valve",          "BV-M",   "Brass",     "Industry", "EA", "utility", "chiller")),
    (r'\bBV.?S\b|BALL.*SOLENOID',
     _eq("Solenoid Ball Valve",        "BV-S",   "Brass",     "Industry", "EA", "utility", "chiller")),
    (r'\bBV.?LC\b|BALL.*MODULATING|BALL.*LINEAR',
     _eq("Modulating Ball Valve",      "BV-LC",  "Brass",     "Industry", "EA", "utility", "chiller")),
    (r'\bBFV.?UA\b|BUTTERFLY.*UTIL.*ACT',
     _eq("Actuator Butterfly Valve", "BFV-UA", "Cast Iron/Disc SS304", "JIS10K", "EA", "utility", "chiller")),
    (r'\bBFV.?UM\b|BUTTERFLY.*UTIL.*MAN',
     _eq("Manual Butterfly Valve",   "BFV-UM", "Cast Iron/Disc SS304", "JIS10K", "EA", "utility", "chiller")),
    (r'\bDV.?A\b|DIAPHRAGM.*ACTUATOR',
     _eq("Actuator Diaphragm Valve",   "DV-A",   "Cast Iron", "Industry", "EA", "utility", "chiller")),
    (r'\bDV.?M\b|DIAPHRAGM.*MANUAL',
     _eq("Manual Diaphragm Valve",     "DV-M",   "Cast Iron", "Industry", "EA", "utility", "chiller")),
    (r'\bDV.?S\b|DIAPHRAGM.*SOLENOID',
     _eq("Solenoid Diaphragm Valve",   "DV-S",   "Cast Iron", "Industry", "EA", "utility", "chiller")),
    (r'\bASV.?A\b|ANGLE.?SEAT.*ACTUATOR',
     _eq("Actuator Angle Seat Valve",  "ASV-A",  "SS304",     "Industry", "EA", "utility", "steam")),
    (r'\bASV.?M\b|ANGLE.?SEAT.*MANUAL',
     _eq("Manual Angle Seat Valve",    "ASV-M",  "SS304",     "Industry", "EA", "utility", "steam")),
    (r'\bASV.?S\b|ANGLE.?SEAT.*SOLENOID',
     _eq("Solenoid Angle Seat Valve",  "ASV-S",  "SS304",     "Industry", "EA", "utility", "steam")),
    (r'\bAV.?M\b|ANGLE.?VALVE.*MANUAL',
     _eq("Manual Angle Valve",         "AV-M",   "Cast Iron", "Industry", "EA", "utility", "chiller")),
    (r'\bCV\b|CHECK.?VALVE',
